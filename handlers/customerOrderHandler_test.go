...
func TestSix910Handler_ViewCustomerOrder(t *testing.T) {
	...
	trans.Method = "PayPal"
	var tranlst []sdbi.OrderTransaction
	tranlst = append(tranlst, trans)
	sapi.MockOrderTransactionList = &tranlst
...
func TestSix910Handler_ViewCustomerOrder2(t *testing.T) {
	var sh Six910Handler
	var l lg.Logger
	l.LogLevel = lg.AllLevel
	sh.Log = &l
