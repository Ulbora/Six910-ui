...
func TestSix910Handler_StoreAdminEditStorePage(t *testing.T) {
...
func TestSix910Handler_StoreAdminEditStorePageLogin(t *testing.T) {
	var sh Six910Handler
	var l lg.Logger
	l.LogLevel = lg.AllLevel
	sh.Log = &l
...
func TestSix910Handler_StoreAdminEditStore(t *testing.T) {
	var sh Six910Handler
	var l lg.Logger
	l.LogLevel = lg.AllLevel
	sh.Log = &l
...
func TestSix910Handler_StoreAdminEditStoreLogin(t *testing.T) {
	var sh Six910Handler
	var l lg.Logger
	l.LogLevel = lg.AllLevel
	sh.Log = &l
...
func TestSix910Handler_StoreAdminEditStoreFail(t *testing.T) {
	var sh Six910Handler
	var l lg.Logger
	l.LogLevel = lg.AllLevel
	sh.Log = &l
